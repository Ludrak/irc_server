...
class RelayedClient : RelayedEntity, ClientInfo
{
	public:
		static const int	value_type;
    
    public:
        RelayedClient(Server &relay, const int hop, const std::string &nick, const std::string &name, const std::string &real_name, const uint mode);
};
