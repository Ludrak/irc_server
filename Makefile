...
# - use "-" if empty
SRCS		= IRCServer.cpp AEntity.cpp Client.cpp AClient.cpp AServer.cpp Channel.cpp SockStream.cpp Package.cpp IRCProtocol.cpp Protocol.cpp Parser.cpp Logger.cpp SockManager.cpp main.cpp	
HEADERS		= IRCServer.hpp AEntity.hpp Client.hpp AClient.hpp AServer.hpp Channel.hpp SockStream.hpp Package.hpp IRCProtocol.hpp Protocol.hpp Parser.hpp Logger.hpp SockManager.hpp IProtocol.hpp
