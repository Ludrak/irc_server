...
HEADERS		= IRCServer.hpp AEntity.hpp Client.hpp AClient.hpp AServer.hpp Channel.hpp SockStream.hpp Package.hpp IRCProtocol.hpp Protocol.hpp Parser.hpp Logger.hpp IProtocol.hpp ntos.hpp
